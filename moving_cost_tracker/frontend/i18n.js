...
const I18N = {
  he: {
    ...
    hero_gross_net:'סה״כ הוצאה / מהכיס שלכם, אחרי {sold} שנמכרו', hero_gross_only:'סה״כ הוצאה',
  ...
  en: {
    ...
    hero_gross_net:'Total spent / out of your pocket, after {sold} sold', hero_gross_only:'Total spent',
